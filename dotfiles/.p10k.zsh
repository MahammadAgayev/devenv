...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=$rp_border
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=$rp_border
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$rp_foam
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=$rp_love
  ...
  ##################################[ dir: current directory ]##################################
  # Default current directory color. Matches pi's statusline `path` segment,
  # which resolves to the theme's `muted` role -> subtle (#908caa).
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=$rp_subtle
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=$rp_subtle
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=$rp_subtle
  # Display anchor directory segments in bold. pi renders the whole path flat,
  # so no emphasis on the last component.
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%F{#56526e}'  # border foreground
      local   modified='%F{#56526e}'  # border foreground
      local  untracked='%F{#56526e}'  # border foreground
      local conflicted='%F{#56526e}'  # border foreground
    fi
  ...
  # Custom icon. Blank: the default is a per-remote identifier (an octocat on
  # GitHub, a fox on GitLab), and the branch icon already says "this is git".
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_FOREGROUND=$rp_love
  typeset -g POWERLEVEL9K_STATUS_ERROR_VISUAL_IDENTIFIER_EXPANSION='✘'

  # Status when the last command was terminated by a signal.
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL=true
  typeset -g POWERLEVEL9K_STATUS_ERROR_SIGNAL_FOREGROUND=$rp_love
  ...
  typeset -g POWERLEVEL9K_STATUS_ERROR_PIPE_FOREGROUND=$rp_love
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=$rp_iris
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_CPU_ARCH_FOREGROUND=$rp_subtle
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=$rp_muted
