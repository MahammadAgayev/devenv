...
/**
 * Agents live in `~/devenv/pi/agents/`, which `ansible/configure.yml`
 * symlinks onto `~/.pi/agent/agents` — so they are discovered as ordinary
 * user-scope agents, with no separate bundled tier.
 */
